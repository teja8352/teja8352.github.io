...
/***/ 4010:
/*!*******************************************************************!*\
  !*** ./src/app/pages/gurukul/add-test/add-test-routing.module.ts ***!
  \*******************************************************************/
...
/* harmony import */ var _add_test_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-test.page */ 7553);
...
/***/ 7738:
/*!***********************************************************!*\
  !*** ./src/app/pages/gurukul/add-test/add-test.module.ts ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _add_test_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-test-routing.module */ 4010);
/* harmony import */ var _add_test_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-test.page */ 7553);
...
/***/ 7553:
/*!*********************************************************!*\
  !*** ./src/app/pages/gurukul/add-test/add-test.page.ts ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _add_test_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-test.page.html?ngResource */ 1389);
/* harmony import */ var _add_test_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-test.page.scss?ngResource */ 2769);
...
let AddTestPage = class AddTestPage {
    constructor(fb, dataService, stateService, commonService) {
        this.fb = fb;
    ...
    createForm() {
        this.testForm = this.fb.group({
            course_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__.UntypedFormControl(this.course.id, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.required])),
            title: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__.UntypedFormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.required])),
            description: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__.UntypedFormControl(null),
            start_date: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__.UntypedFormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.required])),
            end_date: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__.UntypedFormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.required])),
            id: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__.UntypedFormControl(null),
            created_at: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__.UntypedFormControl(null),
            updated_at: new _angular_forms__WEBPACK_IMPORTED_MODULE_5__.UntypedFormControl(null)
        });
    }
    addTest() {
        console.log(this.testForm.value);
        const payload = this.testForm.value;
        delete payload.id;
        delete payload.created_at;
        delete payload.updated_at;
        this.dataService.addTest({ ...this.testForm.value }).then((resp) => {
            if (resp.id) {
                this.testForm.reset();
                // this.back();
    ...
    back() {
        this.commonService.navigateBack('gurukul/courses/tests');
    }
};
...
AddTestPage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        selector: 'app-add-test',
        template: _add_test_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_add_test_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
], AddTestPage);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_Users_teja_Desktop_Teja_Gurukul_gurukul_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_Users_teja_Desktop_Teja_Gurukul_gurukul_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_Users_teja_Desktop_Teja_Gurukul_gurukul_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,_Users_teja_Desktop_Teja_Gurukul_gurukul_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
...
/***/ 2769:
/*!**********************************************************************!*\
  !*** ./src/app/pages/gurukul/add-test/add-test.page.scss?ngResource ***!
  \**********************************************************************/
/***/ ((module) => {

module.exports = "ion-item {\n  --background: rgba(var(--ion-color-light)) !important;\n  border-radius: 5px;\n}\n\n.sc-ion-input-md-h {\n  --placeholder-color: var(--ion-color-medium) !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */";

/***/ }),

/***/ 1389:
/*!**********************************************************************!*\
  !*** ./src/app/pages/gurukul/add-test/add-test.page.html?ngResource ***!
  \**********************************************************************/
/***/ ((module) => {

module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <!-- <ion-button (click)=\"back()\">\n        <ion-icon slot=\"icon-only\" name=\"chevron-back-outline\"></ion-icon>\n      </ion-button> -->\n      <ion-back-button icon=\"chevron-back-outline\" defaultHref=\"gurukul/courses/tests\"></ion-back-button>\n    </ion-buttons>\n    <ion-title>{{status}} Test</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content class=\"ion-padding\">\n\n  <form [formGroup]=\"testForm\" (submit)=\"addTest()\">\n    <ion-row>\n      <ion-col size=\"12\" size-md=\"6\" size-lg=\"4\" size-xl=\"3\">\n        <ion-item color=\"light\" lines=\"none\">\n          <ion-label position=\"floating\">Course Name</ion-label>\n          <ion-input [value]=\"course.title\" readonly disabled></ion-input>\n        </ion-item>\n      </ion-col>\n      <ion-col size=\"12\" size-md=\"6\" size-lg=\"4\" size-xl=\"3\">\n        <ion-item color=\"light\" lines=\"none\">\n          <ion-label position=\"floating\">Test Name</ion-label>\n          <ion-input type=\"text\" formControlName=\"title\"></ion-input>\n        </ion-item>\n      </ion-col>\n      <ion-col size=\"12\" size-md=\"6\" size-lg=\"4\" size-xl=\"3\">\n        <ion-item color=\"light\" lines=\"none\">\n          <ion-label position=\"floating\">Description</ion-label>\n          <ion-input type=\"text\" formControlName=\"description\"></ion-input>\n        </ion-item>\n      </ion-col>\n      <ion-col size=\"12\" size-md=\"6\" size-lg=\"4\" size-xl=\"3\">\n        <ion-item id=\"start-date\" lines=\"none\" color=\"light\">\n          <ion-label>Start Time</ion-label>\n          <ion-text slot=\"end\">{{ testForm.value.start_date | date: 'hh:mm a' }}</ion-text>\n          <ion-popover trigger=\"start-date\" show-backdrop=\"false\">\n            <ng-template>\n              <ion-datetime #startDateTime presentation=\"time\" hourCycle=\"h12\" formControlName=\"start_date\">\n                <div slot=\"title\">Select Start Time</div>\n              </ion-datetime>\n            </ng-template>\n          </ion-popover>\n        </ion-item>\n      </ion-col>\n      <ion-col size=\"12\" size-md=\"6\" size-lg=\"4\" size-xl=\"3\">\n        <ion-item id=\"end-date\" lines=\"none\" color=\"light\">\n          <ion-label>End Time</ion-label>\n          <ion-text slot=\"end\">{{ testForm.value.end_date | date: 'hh:mm a'}}</ion-text>\n          <ion-popover trigger=\"end-date\" show-backdrop=\"false\">\n            <ng-template>\n              <ion-datetime #startEndTime presentation=\"time\" hourCycle=\"h12\" formControlName=\"end_date\">\n                <div slot=\"title\">Select End Time</div>\n              </ion-datetime>\n            </ng-template>\n          </ion-popover>\n        </ion-item>\n      </ion-col>\n      <ion-col size=\"12\" size-md=\"6\" size-lg=\"4\" size-xl=\"3\" class=\"ion-text-center\">\n        <ion-button type=\"submit\" shape=\"round\" [disabled]=\"testForm.invalid\">Submit</ion-button>\n      </ion-col>\n    </ion-row>\n  </form>\n\n</ion-content>";
