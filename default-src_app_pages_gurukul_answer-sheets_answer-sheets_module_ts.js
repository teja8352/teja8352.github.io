"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["default-src_app_pages_gurukul_answer-sheets_answer-sheets_module_ts"],{

/***/ 6963:
/*!*****************************************************************************!*\
  !*** ./src/app/pages/gurukul/answer-sheets/answer-sheets-routing.module.ts ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AnswerSheetsPageRoutingModule": () => (/* binding */ AnswerSheetsPageRoutingModule)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 2560);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 124);
/* harmony import */ var _answer_sheets_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./answer-sheets.page */ 558);
...
const routes = [
    {
        path: '',
        component: _answer_sheets_page__WEBPACK_IMPORTED_MODULE_0__.AnswerSheetsPage
    }
];
let AnswerSheetsPageRoutingModule = class AnswerSheetsPageRoutingModule {
};
AnswerSheetsPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule.forChild(routes)],
        exports: [_angular_router__WEBPACK_IMPORTED_MODULE_3__.RouterModule],
    })
], AnswerSheetsPageRoutingModule);
...
/***/ 1141:
/*!*********************************************************************!*\
  !*** ./src/app/pages/gurukul/answer-sheets/answer-sheets.module.ts ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AnswerSheetsPageModule": () => (/* binding */ AnswerSheetsPageModule)
/* harmony export */ });
...
/* harmony import */ var _answer_sheets_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./answer-sheets-routing.module */ 6963);
/* harmony import */ var _answer_sheets_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./answer-sheets.page */ 558);
...
let AnswerSheetsPageModule = class AnswerSheetsPageModule {
};
AnswerSheetsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            ...
            _answer_sheets_routing_module__WEBPACK_IMPORTED_MODULE_0__.AnswerSheetsPageRoutingModule
        ],
        declarations: [_answer_sheets_page__WEBPACK_IMPORTED_MODULE_1__.AnswerSheetsPage],
        schemas: [
            _angular_core__WEBPACK_IMPORTED_MODULE_3__.CUSTOM_ELEMENTS_SCHEMA
        ]
    })
], AnswerSheetsPageModule);
...
/***/ 558:
/*!*******************************************************************!*\
  !*** ./src/app/pages/gurukul/answer-sheets/answer-sheets.page.ts ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AnswerSheetsPage": () => (/* binding */ AnswerSheetsPage)
/* harmony export */ });
...
/* harmony import */ var _answer_sheets_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./answer-sheets.page.html?ngResource */ 1666);
/* harmony import */ var _answer_sheets_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./answer-sheets.page.scss?ngResource */ 81);
...
let AnswerSheetsPage = class AnswerSheetsPage {
  constructor(cd, dataService, stateService, storageService, loadingCtrl, commonService, modalCtrl, formBuilder) {
    this.cd = cd;
    ...
    this.dataService.getQuestionPaperByTestId(this.testId).subscribe(resp => {
      this.valuedAnswerSheets = resp[0];
      this.cd.detectChanges();
    });
  }

  ngOnInit() {
    this.dataService.getRemarksByTestId(this.testId, this.data.student_id).subscribe(response => {
      this.remarksForm.patchValue({ ...response[0]
      });
      this.remarks = response[0].remarks;
      this.remarkId = response[0].id;
      this.cd.detectChanges();
    });
    this.createForm();
    this.remarksForm.patchValue({
      ...
      test_name: this.data.test.title,
      student_id: this.data.student_id,
      student_name: this.data.student_name,
      reviewed_by_id: localStorage.getItem('uid'),
      reviewed_by_email: localStorage.getItem('email')
    });
  }

  createForm() {
    this.remarksForm = this.formBuilder.group({
      course_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required])),
      course_name: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required])),
      test_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required])),
      test_name: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required])),
      student_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required])),
      student_name: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required])),
      reviewed_by_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required])),
      reviewed_by_email: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required])),
      total_marks: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required])),
      description_part: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required])),
      objectivce_part: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required])),
      weightage_marks: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required])),
      predicted_marks: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required])),
      remarks: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormControl(null, _angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__.Validators.required]))
    });
  }
  ...
  submitRemarks() {
    ...
    const body = { ...this.remarksForm.value
    };

    if (this.commonService.isValidData(this.remarkId)) {
      body.id = this.remarkId;
    }

    this.dataService.update(src_app_constants_fb_collections__WEBPACK_IMPORTED_MODULE_3__.FirebaseCollections.STUDENT_ACTIVITY, body).then(resp => {
      this.commonService.presentToast('Remarks submitted');
      this.reset();
      this.dataService.getRemarksByTestId(this.testId, this.data.student_id).subscribe(response => {
        this.remarksForm.patchValue({ ...response[0]
        });
      ...
      console.error('Error while submitting remarks::::::::::::::\n', err);

      if (err.code === 'not-found' || err.code === 'invalid-argument') {
        this.dataService.add(src_app_constants_fb_collections__WEBPACK_IMPORTED_MODULE_3__.FirebaseCollections.STUDENT_ACTIVITY, this.remarksForm.value).then(resp => {
          // console.log(resp);
          this.commonService.presentToast('Remarks submitted');
          this.reset();
          this.dataService.getRemarksByTestId(this.testId, this.data.student_id).subscribe(response => {
          ...
          console.error('Error while adding valued answer sheet:::::::::::\n', error);
        });
      }
    });
  }

  uploadValuedAnswerSheet(event) {
    var _this = this;
    ...
    return (0,_Users_teja_Desktop_Teja_Gurukul_gurukul_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const loading = yield _this.loadingCtrl.create({
        message: 'Uploading valued answer sheet...'
      });
      loading.present();
      ...
      try {
        const file = {
          file: selectedFile,
          name: _this.course.id + '_G_' + _this.testId + '_G_' + selectedFile.name,
          test_id: _this.testId
        };
        const upload = yield _this.storageService.pushFileToStorage(file, `uploads/valued_answer_sheets/${file.name}`);

        if (upload && upload.file_url) {
          const valuedAnswerSheets = {
            file_url: upload.file_url,
            type: _this.commonService.getExtension(selectedFile.name),
            name: selectedFile.name,
            test_id: _this.testId,
            student_id: _this.data.student_id,
            student_name: _this.data.student_name
          };

          if (_this.commonService.isValidData(_this.valuedAnswerSheets?.id)) {
            valuedAnswerSheets.id = _this.valuedAnswerSheets.id;
          }

          _this.dataService.update(src_app_constants_fb_collections__WEBPACK_IMPORTED_MODULE_3__.FirebaseCollections.VALUED_ANSWER_SHEET, valuedAnswerSheets).then(resp => {
            // console.log('resp::::::::::::\n', resp);
            loading.dismiss();
          }, err => {
            loading.dismiss();
            console.error('Error while uploading valued answer sheet:::::::::::\n', { ...err
            });

            if (err.code === 'not-found' || err.code === 'invalid-argument') {
              _this.dataService.add(src_app_constants_fb_collections__WEBPACK_IMPORTED_MODULE_3__.FirebaseCollections.VALUED_ANSWER_SHEET, valuedAnswerSheets).then(resp => {
                // console.log(resp);
                _this.dataService.getScheduleByTestId(_this.testId).subscribe(response => {
                  _this.valuedAnswerSheets = response[0];
                });
              }, error => {
                console.error('Error while adding valued answer sheet:::::::::::\n', error);
              });
        ...
        console.error('Exception while uploading valued answer sheet:::::::::::\n', exception, { ...exception
        });
        loading.dismiss();
      }
    })();
...
AnswerSheetsPage.ctorParameters = () => [{
...
AnswerSheetsPage.propDecorators = {
  data: [{
    type: _angular_core__WEBPACK_IMPORTED_MODULE_9__.Input
  }]
};
AnswerSheetsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_9__.Component)({
  selector: 'app-answer-sheets',
  template: _answer_sheets_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  styles: [_answer_sheets_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__]
})], AnswerSheetsPage);
...
/***/ 81:
/*!********************************************************************************!*\
  !*** ./src/app/pages/gurukul/answer-sheets/answer-sheets.page.scss?ngResource ***!
  \********************************************************************************/
/***/ ((module) => {

module.exports = "#fileInput,\n#uploadReview {\n  position: absolute;\n  opacity: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */";

/***/ }),

/***/ 1666:
/*!********************************************************************************!*\
  !*** ./src/app/pages/gurukul/answer-sheets/answer-sheets.page.html?ngResource ***!
  \********************************************************************************/
/***/ ((module) => {

module.exports = "<ion-header class=\"ion-no-border\">\n  <ion-toolbar>\n    <ion-buttons slot=\"end\">\n      <ion-button (click)=\"close()\">\n        <ion-icon slot=\"icon-only\" name=\"close\"></ion-icon>\n      </ion-button>\n    </ion-buttons>\n    <ion-title>Upload Review</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content class=\"ion-padding\" color=\"white\">\n  <form (submit)=\"submitRemarks()\" [formGroup]=\"remarksForm\">\n    <ion-row>\n      <ion-col size=\"12\">\n        <ion-item class=\"mb-3\">\n          <ion-label position=\"floating\">Total Marks</ion-label>\n          <ion-input type=\"tel\" formControlName=\"total_marks\"></ion-input>\n        </ion-item>\n      </ion-col>\n      <ion-col size=\"6\">\n        <ion-item class=\"mb-3\">\n          <ion-label position=\"floating\">Descriptive Part</ion-label>\n          <ion-input type=\"tel\" formControlName=\"description_part\"></ion-input>\n        </ion-item>\n      </ion-col>\n      <ion-col size=\"6\">\n        <ion-item class=\"mb-3\">\n          <ion-label position=\"floating\">Objective Part</ion-label>\n          <ion-input type=\"tel\" formControlName=\"objectivce_part\"></ion-input>\n        </ion-item>\n      </ion-col>\n      <ion-col size=\"12\">\n        <ion-item class=\"mb-3\">\n          <ion-label position=\"floating\">Weightage in main exam</ion-label>\n          <ion-input type=\"tel\" formControlName=\"weightage_marks\"></ion-input>\n        </ion-item>\n      </ion-col>\n      <ion-col size=\"12\">\n        <ion-item class=\"mb-3\">\n          <ion-label position=\"floating\">Score predicted in main exam</ion-label>\n          <ion-input type=\"tel\" formControlName=\"predicted_marks\"></ion-input>\n        </ion-item>\n      </ion-col>\n      <ion-col size=\"12\" style=\"height: 700px\" class=\"pb-3\">\n        <ion-list-header color=\"light\" class=\"fw-bold size-16\">Remarks</ion-list-header>\n        <quill-editor [(ngModel)]=\"remarks\" [ngModelOptions]=\"{standalone: true}\"> </quill-editor>\n      </ion-col>\n      <ion-col size=\"12\">\n        <ion-button type=\"submit\">Submit Remark</ion-button>\n      </ion-col>\n    </ion-row>\n  </form>\n</ion-content>\n\n<ion-footer>\n  <ion-toolbar>\n    <input type=\"file\" #f id=\"fileInput\" (change)=\"uploadValuedAnswerSheet($event)\" accept=\"application/pdf\" />\n    <ion-button for=\"fileInput\" expand=\"full\" class=\"ion-no-margin\" size=\"large\" (click)=\"f.click()\">\n      <span style=\"font-size: 14px\">Upload Valued Answer Sheet</span>\n    </ion-button>\n  </ion-toolbar>\n</ion-footer>";
...
class QuillService {
  constructor(injector, config) {
    ...
    this.config = config;
    this.quill$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.defer)( /*#__PURE__*/(0,_Users_teja_Desktop_Teja_Gurukul_gurukul_admin_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!_this.Quill) {
...
//# sourceMappingURL=default-src_app_pages_gurukul_answer-sheets_answer-sheets_module_ts.js.map